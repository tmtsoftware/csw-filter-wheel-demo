...
object Parameter {
  ...
  private[param] implicit def parameterFormat2: Format[Parameter[_]] = new Format[Parameter[_]] {
  ...
  private[param] implicit def parameterFormat[T: Format: ClassTag]: Format[Parameter[T]] =
 ...
 */
case class Parameter[S: Format: ClassTag] private[param] (
    keyName: String,
    keyType: KeyType[S],
    items: mutable.WrappedArray[S],
    units: Units
