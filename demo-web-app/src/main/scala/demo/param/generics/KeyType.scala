...
import demo.param.models.Units.second
import demo.param.models._
...
sealed class KeyType[S: Format: ClassTag] extends EnumEntry with Serializable {
  ...
  private[param] def paramFormat: Format[Parameter[S]] = Parameter[S]
}
...
object KeyType extends Enum[KeyType[_]] with PlayJsonEnum[KeyType[_]] {
  ...
  import demo.param.formats.JsonSupport._
